...
object Constants {
    ...
    const val MOVIE_DETAILS_SCREEN = "Movie Details"
    ...
    const val ALREADY_VERIFIED = "Already verified? Click here"
    const val SPAM_EMAIL = "If not, please also check the spam folder of your email."
